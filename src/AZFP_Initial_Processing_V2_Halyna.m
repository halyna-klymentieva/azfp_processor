...
addpath(genpath('D:/AZFP_GSL_2025/AZFPdata_GSL2025/AZFP_202507/AZFP_202507'))
...
% Create a filename based on the current date or the data range
saveName = ['AZFP_Data_Processed_July29', '.mat'];

% Define your save path (Adjust to your D: drive if needed)
savePath = fullfile('D:/AZFP_GSL_2025/AZFP_processed_data/Output_processed/', saveName);

fprintf('Saving processed output to %s...\n', savePath);
save(savePath, 'Output', 'Par', '-v7.3');
fprintf('Save complete. You can now clear the workspace and reload this file later.\n');
...
%% Load in glider data
% Load the specific day you want to work on (if needed)
load('D:/AZFP_GSL_2025/AZFP_processed_data/Output_processed/AZFP_Data_Processed_July25.mat');

% load up the raw datafile downloaded from CEOTR
load('d:/AZFP_GSL_2025/gliderdata_GSL2025/cabot_20250723_213_delayed_0660_8583_ae5f.mat');

% put that data into the variable gliderdata
gliderdata = cabot_20250723_213_delayed;
clear cabot_20250723_213_delayed
...
% save the figure
filename = strcat("d:/AZFP_GSL_2025/plots/dbDiff_July25.png");
print(gcf,'-dpng',filename,'-r0')
